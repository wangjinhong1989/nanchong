...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-jingdu" data-rule="required" class="form-control" name="row[jingdu]" type="number" value="<?php echo htmlentities($row['jingdu']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Weidu'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-weidu" data-rule="required" class="form-control" name="row[weidu]" type="number" value="<?php echo htmlentities($row['weidu']); ?>">
        </div>
    </div>
    <div class="form-group">
