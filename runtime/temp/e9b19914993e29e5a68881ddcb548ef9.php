<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/www.luxiaogui.cn/public/../application/admin/view/article/add.html";i:1576501792;s:72:"/www/wwwroot/www.luxiaogui.cn/application/admin/view/layout/default.html";i:1572536367;s:69:"/www/wwwroot/www.luxiaogui.cn/application/admin/view/common/meta.html";i:1572536366;s:71:"/www/wwwroot/www.luxiaogui.cn/application/admin/view/common/script.html";i:1572536366;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Articletype_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-articletype_id" data-rule="required" data-source="articletype/index" class="form-control selectpage" name="row[articletype_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-files" data-rule="required" class="form-control" size="50" name="row[files]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Modifiy_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-modifiy_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[modifiy_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
