<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"/www/wwwroot/www.luxiaogui.cn/public/../application/index/view/news/index.html";i:1576649198;s:72:"/www/wwwroot/www.luxiaogui.cn/application/index/view/layout/default.html";i:1576651105;s:69:"/www/wwwroot/www.luxiaogui.cn/application/index/view/common/meta.html";i:1574920671;s:70:"/www/wwwroot/www.luxiaogui.cn/application/index/view/common/mynav.html";i:1576657814;s:71:"/www/wwwroot/www.luxiaogui.cn/application/index/view/common/script.html";i:1572536367;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="panel panel-default ">
                <div class="panel-body">
                    <h2 class="page-header">
                        <?php echo __('新闻列表'); ?>
                        <a href="<?php echo url('news/index'); ?>" class="btn btn-success pull-right"><i class="fa fa-pencil"></i>
                            <?php echo __('列表'); ?></a>
                    </h2>
                    <div class="row user-baseinfo">

                        <?php if(is_array($dataList) || $dataList instanceof \think\Collection || $dataList instanceof \think\Paginator): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>

                        <h1>
                            <a href="<?php echo url('news/detail',array('id'=>$item['id'])); ?>" target="_parent"><?php echo $item['title']; ?></a>
                        </h1>
                        <p><?php echo $item['description']; ?></p>
                        <p><?php echo datetime($item['create_time']); ?></p>
                        <p><?php echo $item['read_count']; ?></p>
